    ...
    >
      ...
      <div className="relative overflow-hidden px-5 py-4 flex items-center justify-between" style={{ minHeight: "72px" }}>
        ...
        <div className="relative z-10 flex items-center gap-3">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/echotvlogo.png" alt="Echo TV Studios logo" className="h-9 w-auto object-contain shrink-0" />
          <div>
        ...
        {/* Right side: expand toggle + visit site */}
        <div className="relative z-10 flex items-center gap-2">
          <button
            onClick={() => setExpanded((v) => !v)}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-black transition hover:opacity-90"
      ...
      {expanded && (
        <div className="bg-white px-5 py-5">
          ...
          {/* Thumbnail → opens episode in new tab */}
          <a
            href={EPISODE_URL}
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(150deg, #0d1a2e 0%, #1a2e50 50%, #0d1a2e 100%)", aspectRatio: "16/9" }}
            >
              {[
              ...
              <div className="relative z-10 flex flex-col items-center gap-2 px-6 text-center">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/echotvlogo.png" alt="Echo TV Studios" className="mb-1 object-contain" style={{ height: "36px", width: "auto" }} />
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] mb-0.5" style={{ color: GOLD }}>Echo TV Studios</p>
                  <div className="flex items-center gap-2 justify-center">
                    <div className="h-px w-10" style={{ background: "rgba(201,149,42,0.4)" }} />
                    <p className="text-[9px] uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.45)" }}>Christian Television</p>
                    <div className="h-px w-10" style={{ background: "rgba(201,149,42,0.4)" }} />
                  </div>
                </div>
