...
const BOOKS = [
  ...
  },
  {
    ...
    subtitle:    "The Ark Story — Based on Genesis 6–9",
    description: "When a golden compass zaps Mav and Moony back in time, they land smack in the middle of the greatest building project in history. What is sin? Why a flood? And who closes the door? Find out in this funny, faith-packed adventure!",
  ...
  },
  {
    ...
    subtitle:    "Based on the Book of Jonah",
    description: "Mav and Moony's compass zaps them back in time — right into the middle of the greatest runaway story ever told. They meet Jonah, ride out a monster storm, and discover that you can't outrun God's mercy. A funny, heart-pounding adventure about second chances!",
    scripture:   "Jonah 2:9",
    ages:        "Ages 4–12",
    pages:       "20 pages",
    theme:       "Mercy & Second Chances",
    coverEmoji:  "🐟",
  ...
  },
  {
    ...
    subtitle:    "Every Person Matters to God — John 3:16",
    description: "Mav and Moony pile into the family minivan for the ultimate cross-country adventure! From Texas BBQ to the Grand Canyon, the Nevada desert to the California coast — they meet new friends, get into all kinds of trouble, and discover that no matter where you go, God's love reaches everyone.",
    scripture:   "John 3:16",
    ages:        "Ages 7–12",
    pages:       "30 pages",
  ...
  },
  {
    ...
    subtitle:    "He Is the Resurrection — John 11:25",
    description: "Mav and Moony travel back in time to ancient Judea and witness something no one thought possible — Jesus calling Lazarus back from the dead. A powerful story about faith before the miracle, and a God who enters our grief and defeats our darkest fears.",
  ...
  },
  {
    ...
    subtitle:    "Peace, Be Still — Based on Mark 4:35–41",
    description: "When a sudden storm threatens to swamp their little rowboat, Mav and Moony learn what it really means to trust God in the middle of the waves. A stunning, faith-packed adventure about courage, fear, and the One who speaks to storms.",
    scripture:   "Mark 4:39",
    ages:        "Ages 5–12",
    pages:       "20 pages",
    theme:       "Faith & Trusting God",
    coverEmoji:  "⛈️",
  ...
  },
  {
    ...
    subtitle:    "Joseph in Egypt — Genesis 37–41",
    description: "A golden portal zaps Mav and Moony back to ancient Egypt, where they meet Joseph — sold into slavery by his own brothers, forgotten in prison, yet lifted up by God to save many lives. A powerful story about forgiveness, patience, and trusting that God can turn harm into good.",
    scripture:   "Genesis 50:20",
    ages:        "Ages 7–12",
    pages:       "18 pages",
    theme:       "Forgiveness & Trust",
    coverEmoji:  "🌈",
