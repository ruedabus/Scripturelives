...
const BOOKS = [
  ...
  {
    slug:        "riders-of-the-ark",
    title:       "Mav y Moony: Jinetes del Arca",
    subtitle:    "La Historia del Arca — Basado en Génesis 6–9",
    description: "Cuando una brújula dorada teletransporta a Mav y Moony en el tiempo, aterrizan justo en medio del proyecto de construcción más grande de la historia. ¿Qué es el pecado? ¿Por qué un diluvio? ¿Y quién cierra la puerta? ¡Descúbrelo en esta aventura divertida y llena de fe!",
    scripture:   "Génesis 7:16",
    ages:        "Edades 4–12",
    pages:       "20 páginas",
    theme:       "Fe y Obediencia",
    coverEmoji:  "🌊",
  ...
  },
  {
    ...
    title:       "Mav, Moony y Goliat: La Gran Aventura de Campamento",
    subtitle:    "Perdidos en el Bosque — Jeremías 33:3",
    description: "Mav, Moony y su nuevo amigo gigante Goliat se escapan al bosque en un campamento de verano y se pierden por completo. Cuando toda esperanza se desvanece, Mav recuerda lo que su abuela siempre decía — y guía a sus amigos en oración. Una historia de aventura, amistad, humor y confianza en Dios incluso en los lugares más oscuros.",
    scripture:   "Jeremías 33:3",
    ages:        "Edades 4–12",
    pages:       "22 páginas",
    theme:       "Fe y Amistad",
    coverEmoji:  "⛺",
  ...
  {
    slug:        "big-fish-adventure",
    title:       "Mav y Moony: La Gran Aventura del Pez Gigante",
    subtitle:    "Basado en el Libro de Jonás",
    description: "La brújula de Mav y Moony los transporta en el tiempo — justo en medio de la historia de fuga más grande jamás contada. Conocen a Jonás, sobreviven una tormenta monstruosa y descubren que no se puede escapar de la misericordia de Dios. ¡Una aventura divertida y emocionante sobre las segundas oportunidades!",
    scripture:   "Jonás 2:9",
    ages:        "Edades 4–12",
    pages:       "20 páginas",
    theme:       "Misericordia y Segundas Oportunidades",
    coverEmoji:  "🐟",
    coverImage:  "/ebook5-titlecard.png",
    coverBg:     "linear-gradient(135deg, #0a1a2e 0%, #0e3d5c 50%, #0a6b8a 100%)",
    accentColor: "#38bdf8",
    downloadUrl: "/books/mav-moony-big-fish-adventure-ebook.pdf",
    badge:       null,
  },
  {
    slug:        "great-american-road-trip",
    title:       "Mav y Moony: El Gran Viaje por Carretera Americano",
    subtitle:    "Cada Persona le Importa a Dios — Juan 3:16",
    description: "¡Mav y Moony se suben a la minivan familiar para la aventura definitiva a través del país! Desde la barbacoa de Texas hasta el Gran Cañón, el desierto de Nevada y la costa de California — conocen nuevos amigos, se meten en todo tipo de líos y descubren que sin importar a dónde vayan, el amor de Dios alcanza a todos.",
    scripture:   "Juan 3:16",
    ages:        "Edades 7–12",
    pages:       "30 páginas",
    theme:       "El Amor de Dios por Todos",
    coverEmoji:  "🚐",
  ...
  {
    slug:        "miracle-at-the-tomb",
    title:       "Mav, Moony y el Milagro en la Tumba",
    subtitle:    "Él Es la Resurrección — Juan 11:25",
    description: "Mav y Moony viajan en el tiempo hasta la antigua Judea y presencian algo que nadie creía posible — Jesús llamando a Lázaro de vuelta de entre los muertos. Una historia poderosa sobre la fe antes del milagro, y un Dios que entra en nuestro dolor y vence nuestros miedos más oscuros.",
    scripture:   "Juan 11:25",
    ages:        "Edades 7–12",
    pages:       "22 páginas",
    theme:       "Fe y el Poder de Dios",
    coverEmoji:  "✝️",
  ...
  {
    slug:        "giant-storm",
    title:       "Mav y Moony y la Tormenta Gigante",
    subtitle:    "Paz, Quédate Quieta — Basado en Marcos 4:35–41",
    description: "Cuando una tormenta repentina amenaza con hundir su pequeño bote de remos, Mav y Moony aprenden lo que realmente significa confiar en Dios en medio de las olas. Una aventura impresionante y llena de fe sobre el valor, el miedo y Aquel que le habla a las tormentas.",
    scripture:   "Marcos 4:39",
    ages:        "Edades 5–12",
    pages:       "20 páginas",
    theme:       "Fe y Confianza en Dios",
    coverEmoji:  "⛈️",
    coverImage:  "/Episode8-titlecard.png",
    coverBg:     "linear-gradient(135deg, #0a0f1e 0%, #0d2340 40%, #1a3a6b 100%)",
    accentColor: "#60c8f5",
    downloadUrl: "/books/mav-moony-giant-storm-ebook.pdf",
    badge:       null,
  },
  {
    slug:        "joseph-in-egypt",
    title:       "Mav, Moony y el Guardián de los Sueños",
    subtitle:    "José en Egipto — Génesis 37–41",
    description: "Un portal dorado transporta a Mav y Moony al antiguo Egipto, donde conocen a José — vendido como esclavo por sus propios hermanos, olvidado en prisión, pero levantado por Dios para salvar muchas vidas. Una historia poderosa sobre el perdón, la paciencia y la confianza en que Dios puede transformar el mal en bien.",
    scripture:   "Génesis 50:20",
    ages:        "Edades 7–12",
    pages:       "18 páginas",
    theme:       "Perdón y Confianza",
    coverEmoji:  "🌈",
    coverImage:  "/Episode9-titlecard.png",
    coverBg:     "linear-gradient(135deg, #1a0f0a 0%, #4a2e0a 40%, #c9952a 100%)",
    accentColor: "#e0a940",
    downloadUrl: "/books/mav-moony-dream-keeper-ebook.pdf",
    badge:       "NUEVO",
  },
];
