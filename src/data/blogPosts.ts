...
export const CATEGORY_COLORS: Record<BlogCategory, { bg: string; text: string }> = {
  ...
  "Hope & Perseverance":    { bg: "bg-teal-100",    text: "text-teal-800"    },
  "Courage & Strength":     { bg: "bg-red-100",     text: "text-red-800"     },
  "Identity in Christ":     { bg: "bg-blue-100",    text: "text-blue-800"    },
  "Healing & Restoration":  { bg: "bg-purple-100",  text: "text-purple-800"  },
};
